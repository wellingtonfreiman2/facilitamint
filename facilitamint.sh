...
# Forçar modo não interativo para evitar telas de configuração
...
# 3. Instalar pacotes essenciais (pré-configuração para evitar EULA)
echo -e "${VERDE}📦 Instalando pacotes básicos e apps solicitados...${SEM_COR}"

# Aceitar EULA das fontes Microsoft antes de instalar
