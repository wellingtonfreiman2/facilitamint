...
# Verifica pacotes APT quebrados
sudo apt --fix-broken install -y

# Verifica se os Flatpaks precisam de reparo
sudo flatpak repair

# Limpa pacotes desnecessários para manter o sistema limpo
sudo apt autoremove -y && sudo apt autoclean

echo -e "${VERDE}✅ Instalação e verificação concluídas com sucesso!${SEM_COR}"
echo "----------------------------------------------------------------"
