...
# 3. Instalar pacotes essenciais (sem telegram-desktop, pois será via flatpak)
...
# 5. Flatpak apps (sistema) - incluindo Whatsie e Telegram
...
sudo flatpak install -y --system flathub com.discordapp.Discord \
    ...
    com.rtosta.whatsie org.telegram.desktop
...
if [ ! -d "$ZASH_DIR" ]; then
    ...
    # Link simbólico para o executável
