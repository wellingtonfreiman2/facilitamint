...
# 3. Instalar pacotes essenciais (inclui qbittorrent e telegram)
...
sudo apt install -y curl wget git zsh flatpak ubuntu-restricted-extras \
    ttf-mscorefonts-installer qbittorrent telegram-desktop
...
# 5. Flatpak apps (sistema) - incluindo Whatsie
