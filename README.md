...
![Mint](https://shields.io)
![License: MIT](https://shields.io)

---

## 🛠️ Sobre o Projeto
Este é um script de automação em Bash projetado para transformar uma instalação limpa (Debian/Ubuntu/Mint) em uma estação de trabalho e jogos completa em minutos.
